                ...
                <div className="row align-items-center justify-content-lg-between">
                    <div className="col-lg-6">
                        <div className="about_image_1">
                            ...
                            <Image src={about2} data-parallax='{"y" : 80, "smoothness": 6}' alt="Piontech - About" />
                            <Image src={about3} data-parallax='{"y" : -80, "smoothness": 6}' alt="Piontech - About" />
                        </div>
                    </div>
                        ...
                        <div className="about_content">
                            <div className="heading_block">
                                <div className="heading_focus_text">
                                    We are ðŸ˜ƒ
                                    <span className="badge bg-secondary text-white">Piontech</span>
                                </div>
                                <h2 className="heading_text">
                                    Our Commitment to Client Satisfaction
                                </h2>
                                <p className="heading_description mb-0">
                                    At Piontech, our commitment to client satisfaction is at the core of everything we do. We understand clients' success.
                                </p>
                            </div>
