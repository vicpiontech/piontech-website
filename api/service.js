...
const getPartnerFolder = (slug) => {
  const map = {
    'ict-solutions-systems-and-hardware': 'ict solutions',
    'integrated-security-solutions': 'integrated security',
    'enterprise-applications': 'enterprise applications',
    'custom-software-and-integration': 'custom software',
    'telecommunication-solutions': 'telecommunication',
    'power-and-renewable-energy': 'power energy',
    'smart-facilities-and-automation': 'smart facilities automation',
    'iot-solutions-and-remote-monitoring': 'iot solutions',
  };
  return map[slug] || '';
};

const makePartners = (slug, extraGroups = []) => {
  const folder = getPartnerFolder(slug);
  const group = (title, nums) => ({
    title,
    logos: folder
      ? nums.map(n => ({
          src: `/images/partners/${folder}/partner_logo_${n}.webp`,
          alt: `Partner Logo ${n}`,
        }))
      : [],
  });
  return [...group('Technology Partners', [4, 18, 27, 29]), ...group('Solutions Partners', [22, 23, 38]), ...extraGroups];
};
...
const Services = [
  {
    ...
    details: {
      ...
      partners: makePartners('ict-solutions-systems-and-hardware', [
        { title: 'Software & Communication Partners', logos: [
          { src: '/images/partners/ict solutions/partner_logo_5.webp', alt: 'Partner 5' },
          { src: '/images/partners/ict solutions/partner_logo_7.webp', alt: 'Partner 7' },
          { src: '/images/partners/ict solutions/partner_logo_8.webp', alt: 'Partner 8' },
        ]}
      ])
    },
  ...
  },
  {
    ...
    details: {
      ...
      partners: makePartners('integrated-security-solutions')
    },
    showOnServicePage: true,
    showOnHome: true
  },
  {
    ...
    details: {
      ...
      partners: makePartners('enterprise-applications')
    },
    showOnServicePage: true,
    showOnHome: true
  },
  {
    ...
    details: {
      ...
      partners: makePartners('custom-software-and-integration')
    },
    showOnServicePage: true,
    showOnHome: true
  },
  {
    ...
    details: {
      ...
      partners: makePartners('telecommunication-solutions')
    },
    showOnServicePage: true,
    showOnHome: true
  },
  {
    ...
    details: {
      ...
      partners: makePartners('power-and-renewable-energy')
    },
    showOnServicePage: true,
    showOnHome: true
  },
  {
    ...
    details: {
      ...
      partners: makePartners('smart-facilities-and-automation')
    },
    showOnServicePage: true,
    showOnHome: false
  },
  {
    ...
    details: {
      ...
      partners: makePartners('iot-solutions-and-remote-monitoring')
    },
    showOnServicePage: true,
    showOnHome: false
  },
